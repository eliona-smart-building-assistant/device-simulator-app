...
- `app_name.configuration`: Contains configuration of the app. Editable through the API.

- `app_name.asset`: Provides asset mapping. Maps broker's asset IDs to Eliona asset IDs.
