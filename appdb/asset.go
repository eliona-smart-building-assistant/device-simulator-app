...
var AssetWhere = struct {
	...
	ID:              whereHelperint64{field: "\"device_simulator\".\"asset\".\"id\""},
	ConfigurationID: whereHelperint64{field: "\"device_simulator\".\"asset\".\"configuration_id\""},
	ProjectID:       whereHelperstring{field: "\"device_simulator\".\"asset\".\"project_id\""},
	GlobalAssetID:   whereHelperstring{field: "\"device_simulator\".\"asset\".\"global_asset_id\""},
	ProviderID:      whereHelperstring{field: "\"device_simulator\".\"asset\".\"provider_id\""},
	AssetID:         whereHelpernull_Int32{field: "\"device_simulator\".\"asset\".\"asset_id\""},
}
...
func (assetL) LoadConfiguration(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAsset interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`device_simulator.configuration`),
		qm.WhereIn(`device_simulator.configuration.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func Assets(mods ...qm.QueryMod) assetQuery {
	mods = append(mods, qm.From("\"device_simulator\".\"asset\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"device_simulator\".\"asset\".*"})
	}
...
func FindAsset(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Asset, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"device_simulator\".\"asset\" where \"id\"=$1", sel,
	)
...
func (o *Asset) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"device_simulator\".\"asset\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"device_simulator\".\"asset\" %sDEFAULT VALUES%s"
		}
...
func (o *Asset) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"device_simulator\".\"asset\" SET %s WHERE %s",
...
func (o AssetSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"device_simulator\".\"asset\" SET %s WHERE %s",
...
func (o *Asset) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"device_simulator\".\"asset\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *Asset) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"device_simulator\".\"asset\" WHERE \"id\"=$1"
...
func (o AssetSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"device_simulator\".\"asset\" WHERE " +
...
func (o *AssetSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"device_simulator\".\"asset\".* FROM \"device_simulator\".\"asset\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, assetPrimaryKeyColumns, len(*o))
...
func AssetExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"device_simulator\".\"asset\" where \"id\"=$1 limit 1)"
