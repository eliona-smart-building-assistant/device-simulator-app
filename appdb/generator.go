...
var GeneratorWhere = struct {
	...
	TenantID:        whereHelperstring{field: "\"device_simulator\".\"generator\".\"tenant_id\""},
...
var (
	generatorAllColumns            = []string{"id", "tenant_id", "asset_id", "attribute", "subtype", "asset_type", "function_type", "min_value", "max_value", "integer", "interval_seconds", "frequency", "initialized_at"}
	generatorColumnsWithoutDefault = []string{"tenant_id", "asset_id", "attribute", "subtype", "asset_type", "function_type", "min_value", "max_value", "integer", "interval_seconds", "frequency"}
